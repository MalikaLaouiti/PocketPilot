...
public class BudgetService {
        ...
        public Budget genererBudget(UUID idCompte) {
                ...
                System.out.println("Lignes générées: " + lignes.toString());
                ...
                // IMPORTANT: initialize list if null
                budget.setLignesBudget(new ArrayList<>());

                // attach both sides
                for (LigneBudget l : lignes) {
                        l.setBudget(budget);
                        budget.getLignesBudget().add(l);
                }
        ...
        private List<LigneBudget> genererLignes(UUID idCompte, List<AnalyseMensuelle> fenetre,
                ...
                Map<CategorieDepense, List<Transaction>> parCategorie = toutesTransactions.stream()
                                .collect(Collectors.groupingBy(
                                                t -> CategorieDepense.valueOf(t.getCategorie().toUpperCase())));
        ...
        // private boolean detecterRecurrence(List<Transaction> transactions, int
        // nbMois) {
